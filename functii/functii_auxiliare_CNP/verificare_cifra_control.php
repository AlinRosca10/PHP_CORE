<?php
    ...
    function verificare_cifra_control(array $array_cnp){
        ...
        return ['cifra_control' => $cifra_control, 
                'cifra_control2' => $cifra_control2, 
                'suma_cifra_control' => $suma_cifra_control, 
                'validare_cifra_control' => ($cifra_control === $cifra_control2)];
    }
?>